export const DE_PAGES = {
  personas: {
    ...
    mainTopicRequired: 'Bitte wählen Sie ein Hauptthema.',
    noTopics: 'Noch keine Themen. Legen Sie zuerst eines auf der Themen-Seite an.',
  ...
  topics: {
    ...
    emptySearch: 'Keine Themen passen zur Suche.',
    empty: 'Noch keine Themen. Legen Sie eines an, um Umgebungen und Personas zu gruppieren.',
    editTitle: 'Thema bearbeiten',
    newTitle: 'Neues Thema',
    name: 'Name *',
    namePh: 'z. B. Cyberpunk-Nacht',
    description: 'Beschreibung',
    descriptionPh: 'Worum es in diesem Thema geht, die Welt, der Ton, wiederkehrende Regeln…',
    icon: 'Symbol',
    defaultSystem: 'Standard-Systemprompt',
    defaultSystemPh: 'Optionale Erzählerregeln als Vorgabe für dieses Thema',
  ...
  import: {
    ...
    allChatsInScope: 'Alle Geschichten in diesem Bereich',
    includeChats: 'Geschichten einschließen',
    policy: 'Beim Import',
