export const EN_PAGES = {
  personas: {
    ...
    mainTopicRequired: 'Please choose a main topic.',
    noTopics: 'No topics yet. Create one on the Topics page first.',
  ...
  topics: {
    ...
    emptySearch: 'No topics match your search.',
    empty: 'No topics yet. Create one to group environments and personas.',
    editTitle: 'Edit Topic',
    newTitle: 'New Topic',
    name: 'Name *',
    namePh: 'e.g. Cyberpunk Night',
    description: 'Description',
    descriptionPh: 'What this topic is about, the world, tone, recurring rules…',
    icon: 'Icon',
    defaultSystem: 'Default system prompt',
    defaultSystemPh: 'Optional narrator rules applied as a default for this topic',
